	...
	return (
		<>
			...
			<div className="mt-[30px] container mx-auto">
				<div className="flex items-center flex-wrap justify-center">
					<div className="flex flex-wrap p-2 justify-evenly items-center">
						<div className="w-full yl-about-text pera-content text-xl">
							<p>
			...
			<div className="mt-10 max-w-[90%] mx-auto">
				<h1 className="text-center mt-10 font-sans font-bold text-yellow-500 relative after:absolute after:w-[150px] after:left-[50%] after:-translate-x-[50%] after:h-[4px] after:-bottom-2 after:bg-gray-600 text-4xl">Our Services & Products :</h1>
